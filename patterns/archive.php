...
<h5 class="wp-block-heading" style="text-transform:uppercase"><?php esc_html_e('Popular Posts This Week', 'examiner');?></h5>
<!-- /wp:heading -->
...
<!-- wp:myplugin/query-loop-load-more {"width_desktop":"100%","customId":"34c2cc","custom_css":"this_block{text-align:center;}","backgroundColor":"primary","textColor":"white","fontFamily":"montserrat","style":{"elements":{"link":{"color":{"text":"var:preset|color|white"}}},"spacing":{"padding":{"top":"10px","bottom":"10px"}},"typography":{"textTransform":"uppercase"}}} -->
<button type="button" class="wp-block-myplugin-query-loop-load-more query-loop-load-more-button has-white-color has-primary-background-color has-text-color has-background has-link-color has-montserrat-font-family" style="padding-top:10px;padding-bottom:10px;text-transform:uppercase">Load More</button>
<!-- /wp:myplugin/query-loop-load-more --></div>
<!-- /wp:query --></div>
<!-- /wp:column -->

<!-- wp:column {"width":"25%","width_desktop":"25%","customId":"fb3973","style":{"spacing":{"blockGap":"20px"}}} -->
<div class="wp-block-column" style="flex-basis:25%"><!-- wp:cover {"url":"<?php echo esc_url( get_template_directory_uri() ); ?>/assets/images/300x600-examiner-ad.jpg","dimRatio":0,"customOverlayColor":"#595761","isUserOverlayColor":false,"minHeight":625,"minHeightUnit":"px","customId":"808ddc"} -->
<div class="wp-block-cover" style="min-height:625px"><span aria-hidden="true" class="wp-block-cover__background has-background-dim-0 has-background-dim" style="background-color:#595761"></span><img class="wp-block-cover__image-background" alt="" src="<?php echo esc_url( get_template_directory_uri() ); ?>/assets/images/300x600-examiner-ad.jpg" data-object-fit="cover"/><div class="wp-block-cover__inner-container"><!-- wp:paragraph {"align":"center","placeholder":"Write title…","customId":"3bc9c0","fontSize":"large"} -->
...
<h2 class="wp-block-heading has-primary-color has-text-color has-link-color has-montserrat-font-family has-24-font-size"><?php esc_html_e('LATEST NEWS', 'examiner');?></h2>
<!-- /wp:heading -->
